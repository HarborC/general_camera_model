...
TEST(FovCameraModel, cameraModelInitializeParams) {
  GeneralCameraModel camera_model;
  // initialize FovCameraModel class
  camera_model.cameraModelInitializeParams(9, 800, 800, 800);
...
// TEST(FovCameraModel, spaceToPlane) {
//   GeneralCameraModel camera_model;
//   // initialize FovCameraModel class
//   camera_model.cameraModelInitializeParams(9, 800, 800, 800);
...
// TEST(FovCameraModel, planeToSpace) {
//   GeneralCameraModel camera_model;
//   // initialize FovCameraModel class
//   camera_model.cameraModelInitializeParams(9, 800, 800, 800);
