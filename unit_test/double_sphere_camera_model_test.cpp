...
TEST(DoubleSphereCameraModel, cameraModelInitializeParams) {
  GeneralCameraModel camera_model;
  // initialize DoubleSphereCameraModel class
  camera_model.cameraModelInitializeParams(6, 800, 800, 800);
  ...
  EXPECT_EQ(params[4], 1.0);
  EXPECT_EQ(params[5], 0.0);
}

// TEST(DoubleSphereCameraModel, spaceToPlane) {
//   GeneralCameraModel camera_model;
//   // initialize DoubleSphereCameraModel class
//   camera_model.cameraModelInitializeParams(6, 800, 800, 800);
...
// TEST(DoubleSphereCameraModel, planeToSpace) {
//   GeneralCameraModel camera_model;
//   // initialize DoubleSphereCameraModel class
//   camera_model.cameraModelInitializeParams(6, 800, 800, 800);
